...
#To DO:
# 1. Fix the function that  obtains SYMBOL", "ENTREZID", "ENSEMBL in rowData based on 
#The format selected by the user selectgeneformat
#The user selected organism = mouse or human
#Ensure even if i enter entrez id or ensembl id , it should autopopulate accordingly 


#If the user selects any specific coloumn from the drop down - 
#it should be able to generate a plot accordingly - identify if its a numerical data or categorical 
#plots 
